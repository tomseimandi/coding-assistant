...
case "$1" in
  start)
    ...
    start_server "text-embeddings-router --model-id ../../rcouronne/nomic-embed-text-v1/ --port 9090" "/tmp/inference_servers/embedding.pid" "Nomic Embedding server" "/tmp/inference_servers/embedding.log"
    ;;
  stop)
